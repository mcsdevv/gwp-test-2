import ChangeOrganizationModalStyles from '../public/styles/modules/components/changeorganizationmodal.module.css';
...
class ChangeOrganizationModal extends React.Component {
	...
	_renderModalClass = () => {
		const {open} = this.props;
		if( open ) {
			return `${ChangeOrganizationModal.wrap} ${ChangeOrganizationModal.open}`;
		} else {
			return `${ChangeOrganizationModal.wrap}`
		}
	}
		...
		if( this.state.confirmation == false ) {
			return(
				<form>
					...
					<div className={`row ${ChangeOrganizationModal.signin}`}>
	...
	render() {
		...
		return(
			...
			<div className={this._renderModalClass()}>
				...
				<div className={`row ${ChangeOrganizationModal.header}`}>
					<div className="small-6 columns">
						<img className={ChangeOrganizationModal.logo} src="/images/logo.svg" alt="" />
					</div>

					<div className="small-6 columns text-right">
						<button
							className={ChangeOrganizationModal.close}
							onClick={e => {
								this.props.toggle();
							}}
						>
				...
				<div className="text-center">
					<div className="small-12 columns">
						<h2>Claim Content</h2>
						<img className={ChangeOrganizationModal.hr} src="/images/sep.svg" alt="" />
					</div>
				</div>
				<div className={`${ChangeOrganizationModal.form}`}>
