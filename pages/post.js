...
class Post extends React.Component {
	...
	_renderImagePreview() {
		if( this.state.image_url != '' ) {
			return(
				<>
				<span onClick={() => {this._removeImage()}}
			...
			<>
				...
				<div className={`row ${postStyles.pageHeader} text-center`}>
					<div className="small-12 columns">
						...
						<p>Expand the reach of your content to thousands of government and industry professionals.</p>
					</div>
				</div>
									...
									<div className={`row ${postStyles.row}`}>
										<div className="small-12 columns">
											...
											<label>Format{this._renderError('format')}
												<select onChange={this.handleChange} name="format">
											...
											<label><span className={postStyles.tooltip}>Publish Date <img className={postStyles.question} src="/images/question.png" />
											<span className={postStyles.tooltipText}>To give our members the most relevant and up-to-date information, GovWhitePapers accepts content written in the last two years.</span></span> {this._renderError('publication_date')}
										...
										<div className="small-12 columns">
											...
											<div className={postStyles.nav}>
												<button
													...
													className={`js-preview button ${postStyles.button}`}>Publish
												</button>
											</div>
										</div>
									</div>
