...
import promoteStyles from '../public/styles/modules/promote.module.css';
	...
	render() {
		...
		return(
			<>
				...
				<div className={`row ${promoteStyles.pageHeader} text-center`}>
					<div className="small-12 columns">
						<h1>Promote Your Content</h1>
						<img className={promoteStyles.hr} src="/images/sep.svg" alt="" />
						<p>All members can post their government-related content for free, but did you know that we offer upgraded promotional packages to get your content seen by even more of our 100,000+ members?</p>
					</div>
				</div>
				<div className={`row ${promoteStyles.pageContent}`}>
					<div className={`small-12 medium-6 columns text-right ${promoteStyles.image}`}>
						<img src="/images/promote-img.jpg" alt="" />
					</div>
					<div className={`small-12 medium-6 columns ${promoteStyles.text}`}>
				...
				<div className={`${promoteStyles.contact}`}>
					<div className="row">
						<div className="small-12 columns text-center">
							<h2>Custom Promotional Options</h2>
							<img className={promoteStyles.hr} src="/images/sep.svg" alt="" />
							<p>Our team can design a custom campaign that meets your specific needs. Contact us today to get started!</p>
							<Link href="/contact">
								<a className={`button ${promoteStyles.button}`}>Contact Us</a>
							</Link>
						</div>
					</div>
				</div>
